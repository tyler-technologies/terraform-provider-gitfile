...
require (
	...
	github.com/Azure/azure-sdk-for-go v43.1.0+incompatible // indirect
	...
	github.com/goreleaser/goreleaser v0.137.0 // indirect
	github.com/goreleaser/nfpm v1.3.1 // indirect
